...
export const initialState = {
  ...
  diplomacy: {
    envoysSent: { xikou: true, northernTraders: false, southernTribe: false, saltLakeTown: false, copperMountainCity: false, riverPort: false },
  },
  ...
  foreignPolities: {
    xikou: {
      ...
      commodities: { grain: 500000, salt: 0, cloth: 0, dung: 0, herb: 0, iron: 0, copper: 0, silk: 0 },
      production: { farmlandMu: XIKOU_FARMLAND_MU, saltMines: 2, mulberryLandMu: XIKOU_MULBERRY_MU, herbFields: 0, ironMines: 0, copperMines: 0 },
      prices: { grain: 1.0, salt: 4, cloth: 2, herb: 3, iron: 6, copper: 8, silk: 15 },
